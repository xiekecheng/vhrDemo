...
public interface EmpMapper {
    ...
    List<Employee> getEmployeeByPageSize(@Param("page") Integer page, @Param("size")Integer size);

    List<Employee> getEmployeeByEmpName(@Param("page") Integer page, @Param("size") Integer size,@Param("name") String name);

    Long getTotalEmpName(@Param("name") String name);

    Integer selectEmpDept(Integer id);

    List<Employee> getEmpByConditionSearch(@Param("page") Integer page, @Param("size") Integer size, @Param("emp") Employee employee,@Param("date") String[] beginDateScope);

    Long getTotal2(@Param("emp") Employee employee,@Param("beginDataScope") String[] beginDataScope);
